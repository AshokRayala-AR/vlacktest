export default function Footer() {
  return (
    <div className=" flex flex-col mt-10">
      <div className=" flex bg-customHomeBack text-white px-14 pt-14 items-baseline ">
        <div className="flex flex-col w-3/6 px-8 pt-2">
          ...
          <div className="flex bg-customBeige mt-10 text-black justify-around px-5 py-2 text-sm font-medium">
            <div>
              <p>Email me at</p>
