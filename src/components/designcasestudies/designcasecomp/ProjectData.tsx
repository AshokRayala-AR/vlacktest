export const DesignProjectData = [
  {
    ...
    list: [
      ...
      "dsgn-case-abt-prjct-list2",
      "dsgn-case-abt-prjct-list3",
    ],
  },
  {
    ...
    list: [
      ...
      "dsgn-case-h-w-d-list2",
      "dsgn-case-h-w-d-list3",
    ],
  },
];

export const DeliverableData = [
  { title: "client", description: "facebook.com" },
  {
    title: "service",
  ...
  {
    title: "Deliverable",
    description: "UI Screens, UX Flow & Prototype",
  },
];
...
export const KeywordsData = [
  ...
  { title: "dsgn-case-keywords-list5" },
  { title: "dsgn-case-keywords-list6" },
  { title: "dsgn-case-keywords-list7" },
];
