...
export default function UiCard({ item }: { item: PortfolioType }) {
  ...
  return (
    ...
    >
      <div className="md:w-[300px] min-w-[280px] max-w-[280px] md:min-h-[200px] lg:min-w-[400px] lg:min-h-[320px] xl:min-w-[500px]">
        <motion.img
